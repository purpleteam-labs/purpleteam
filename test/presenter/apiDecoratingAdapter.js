...
test.before(async (t) => {
  ...
  t.context.jobFileContentLocalMissingComma = await readFile(`${process.cwd()}/testResources/jobs/job_3.1.0-alpha.3_local_missing_comma`, { encoding: 'utf8' });
  t.context.jobFileContentLocalMissingTypeOfAppScanner = await readFile(`${process.cwd()}/testResources/jobs/job_3.1.0-alpha.3_local_missing_type_of_appScanner`, { encoding: 'utf8' });
